...
\begin{figure}[htbp]
    ...
    \node[desc, below=2pt of features] {46 numerical\\features};
    \node[desc, below=2pt of inference] {MLP / Transformer,\\StandardScaler};
...
\par The dataset contains \textbf{46 numerical features} plus one label column, for a total of 47 columns per record. The features can be grouped into several categories:
...
\begin{itemize}
    ...
    \item \textbf{TCP flag features} (7 features): counts of FIN, SYN, RST, PSH, ACK, ECE, and CWR flags.
...
\hline CICIoT2023 & 2023 & 46.7M & 46 (DPKT) & 33 attacks & IoT smart home \\
\hline
\end{tabular}
\end{center}
